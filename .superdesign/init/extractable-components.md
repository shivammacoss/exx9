...
- Category: layout
- Description: Top header with EXX9 logo, navigation links, user email, profile button
- Extractable props: activeItem (string, default: "dashboard"), userEmail (string, default: "demo@exx9.com")
- Hardcoded: EXX9 text, nav item labels (Dashboard, Trading, Wallet, Portfolio, Social, Algo), Profile button text, all CSS
