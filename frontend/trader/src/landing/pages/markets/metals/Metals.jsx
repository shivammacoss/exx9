...
import { InstrumentTable } from "@/landing/components/markets/instrument-table"
import { BenefitsGrid } from "@/landing/components/markets/benefits-grid"
import { FAQAccordion } from "@/landing/components/markets/faq-accordion"
import { CTABar } from "@/landing/components/markets/cta-bar"
import { PlatformBlurb } from "@/landing/components/markets/platform-blurb"
import { WhatIsSection } from "@/landing/components/markets/what-is-section"
import { 
  Shield, 
  TrendingUp,
  Droplets,
...
export default function MetalsPage() {
  ...
  const handleLoadChart = useCallback((symbol) => {
    ...
    if (typeof window !== "undefined") {
      localStorage.setItem("exx9_chart_symbol", mappedSymbol)
    }
